      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Customer Section</a>
          </div>
        ...
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
					<?php  
						$record = $ob->commonSelect("client","id DESC");
            ...
            <tr>
              ...
              <td><?php if($row['verify_otp'] == "1"){ echo '<button class="btn btn-success btn-round"> Active </button>'; }else{ echo '<button class="btn btn-warning btn-round"> Deactive </button>'; } ?></td>
              <td>
							<a href="delete.php?id=<?php echo $row['id']; ?>&db=&red=" class="btn btn-warning btn-round" onclick="return confirmDelete()"> <i class="material-icons">delete</i> <div class="ripple-container"></div></a>
						  </td>
            </tr>
					<?php  
						}
