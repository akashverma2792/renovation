              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
					...
					?>
            <tr>
              <td><img src="uploads/heads/test.png" onerror=this.src="assets/img/renovation-file.jpg" style="width: 100px;height: 100px;border-radius: 20px;"></td>
              <td><?php echo "Akash Verma"; ?></td>
              <td><?php echo "Description"; ?></td>
              <td>
				<a href="" class="btn btn-warning btn-round"> <i class="material-icons">create</i> <div class="ripple-container"></div></a>
				<a href="" class="btn btn-warning btn-round" onclick="return confirmDelete()"> <i class="material-icons">delete</i> <div class="ripple-container"></div></a>
			  </td>
            </tr>
					<?php  
						}
