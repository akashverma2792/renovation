                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
					<?php
            $record = $ob->commonSelectJoin("heads_category.*,heads.name as headsname","heads_category","heads","heads_category.head_id = heads.id where heads_category.`admin_ids` LIKE '-%".$_SESSION['subAdminLoginSess']['id']."%-'");
