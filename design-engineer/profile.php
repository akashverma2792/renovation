    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
		<?php 
			$record = $ob->commonSelectWhere("`design_engg`","`id` = '".$_SESSION['designLoginSess']['id']."' AND `status` = '1'","id DESC","1");
		...
		?>
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="../controller/updateDesignEngineer.php" method="post" enctype="multipart/form-data">
          <input type="hidden" name="flag" value="updateDesignEngineer">
          <input type="hidden" name="id" value="<?php echo $_SESSION['designLoginSess']['id']; ?>">
          ...
          <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group" style="text-align: center;">
                          <img src="../uploads/design-engineer/<?php echo $row['profile_picture']; ?>" onerror=this.src="../assets/img/renovation-file.jpg" style="width: 100px;height: 100px;border-radius: 20px;">
                        </div>
                      </div>
                      <div class="col-md-3">
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="javascript:;">
                    <img class="img" src="../uploads/design-engineer/<?php echo $row['profile_picture']; ?>" onerror=this.src="../assets/img/renovation-file.jpg" />
                  </a>
                </div>
                <div class="card-body">
                  <h6 class="card-category text-gray">Design Engineer</h6>
