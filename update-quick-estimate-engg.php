  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Update Quick Estimate Engg</h4>
                </div>
				<?php  
					$record = $ob->commonSelectWhere("quick_est_engg","id = '".$_GET['id']."'","id DESC","1");
        ...
        ?>
                            <option value="<?php echo $row1['id']; ?>" <?php if($row1['id'] == $row['admin_id']){ echo "selected"; } ?>><?php echo $row1['name']; ?></option>
        <?php  }  ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <table class="table" id="myTable">
                          <tbody>
                            ...
                            <?php 
                              $timeslt = json_decode($row['timeslots']);  
                              for($k=0; $k < count($timeslt); $k++){
                            ?>
                            <tr id="10000<?php echo $k;?>"><td><?php echo $timeslt[$k]; ?><input type="hidden" name="timeslots[]" value="<?php echo $timeslt[$k]; ?>"></td><td onclick="removerow(10000<?php echo $k;?>)">delete</td></tr>
                          <?php }  ?>
                          </tbody>
                        </table>
                      </div>
