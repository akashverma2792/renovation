        ...
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
					<?php  
						$record = $ob->commonSelectJoin("property.*,quick_est_engg.name as engg_name","property","quick_est_engg","property.engineer_id = quick_est_engg.id where property.customer_id = '".$_SESSION['customerSession']['id']."' AND `property`.`project_phase` = '4'");
            ...
            <tr>
              ...
              <td>
							  <a href="#" class="btn btn-warning btn-round"> <i class="material-icons">visibility</i> <div class="ripple-container"></div></a>
						  </td>
            </tr>
					<?php  
						}
