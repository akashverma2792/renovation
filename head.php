                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
					<?php  
						$record = $ob->commonSelect("heads","id DESC");
						foreach($record as $row){
					?>
            <tr>
              <td><img src="uploads/heads/<?php echo $row['head_picture']; ?>" onerror=this.src="assets/img/renovation-file.jpg" style="width: 100px;height: 100px;border-radius: 20px;"></td>
              <td><?php echo $row['name']; ?></td>
              <td><?php echo $row['description']; ?></td>
              <td>
							<a href="update-heads.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-round"> <i class="material-icons">create</i> <div class="ripple-container"></div></a>
							<a href="delete.php?id=<?php echo $row['id']; ?>&db=heads&red=head" class="btn btn-warning btn-round" onclick="return confirmDelete()"> <i class="material-icons">delete</i> <div class="ripple-container"></div></a>
						  </td>
            </tr>
					<?php  
						}
