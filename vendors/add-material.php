          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="../controller/addMaterial.php" method="post" enctype="multipart/form-data">
				          <input type="hidden" name="flag" value="addMaterial">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" name="measur_qty" class="form-control" value="">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Cost Per Unit</label>
                          <input type="text" name="cost_per_unit" class="form-control" value="">
                        </div>
                      </div>
                      <div class="col-md-3">
