                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
					<?php
            $record = $ob->commonSelectJoinThree("heads_sub_category.*,heads_category.name as catname,heads.name as headname","heads_sub_category","heads_category","heads","heads_sub_category.head_cat_id = heads_category.id","heads_sub_category.head_id = heads.id where heads_sub_category.`admin_ids` LIKE '-%".$_SESSION['subAdminLoginSess']['id']."%-'");
