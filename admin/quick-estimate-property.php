        ...
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
					<?php  
						$record = $ob->commonSelectJoin("property.*,client.name as client_name","property","client","property.customer_id = client.id where sub_admin LIKE '%-".$_SESSION['subAdminLoginSess']['id']."-%' AND `project_phase` = '1'");
            ...
            <tr>
              ...
              <td>
							  <a href="quick-estimate-property-details.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-round"> <i class="material-icons">edit</i> <div class="ripple-container"></div></a>
						  </td>
            </tr>
					<?php  
						}
