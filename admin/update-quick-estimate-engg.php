          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
				...
				<?php  
					$record = $ob->commonSelectWhere("quick_est_engg","id = '".$_GET['id']."' AND admin_id = '".$_SESSION['subAdminLoginSess']['id']."'","id DESC","1");
                ...
                <div class="card-body">
                  <form action="../controller/updateQuickEstEngg.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="redirect" value="subAdmin">
