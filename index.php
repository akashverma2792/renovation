            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <h3 class="card-title">
                    <?php $record = $ob->commonSelect("client","id DESC"); echo $record->rowCount(); ?>
                  </h3>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <h3 class="card-title">
                    <?php $record = $ob->commonSelect("property","id DESC"); echo $record->rowCount(); ?>
                  </h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons text-warning">link</i>
                    <a href="property.php">Go to property</a>
                  </div>
                </div>
              </div>
            </div>
