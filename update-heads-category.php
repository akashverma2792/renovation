            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Update Heads Category</h4>
                </div>
                <?php  
                  $records = $ob->commonSelectWhere("heads_category","id = '".$_GET['id']."'","id DESC","1");
                  foreach($records as $rows){
                ?>
                <div class="card-body">
                  <form action="controller/updateHeadsCategory.php" method="post" enctype="multipart/form-data">
				            <input type="hidden" name="flag" value="updateHeadsCategory">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <select name="head_id" class="form-control">
                            ...
                            ?>
                            <option value="<?php echo $row['id']; ?>" <?php if($row['id'] == $rows['head_id']){ echo "selected"; } ?>><?php echo $row['name']; ?></option>
                          <?php  }  ?>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group" style="text-align: center;">
                          <img src="uploads/heads-cat/<?php echo $row['head_picture']; ?>" onerror=this.src="assets/img/renovation-file.jpg" style="width: 100px;height: 100px;border-radius: 20px;">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="">
