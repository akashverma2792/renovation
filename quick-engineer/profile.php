...
<body class="">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
		<?php 
			$record = $ob->commonSelectWhere("`quick_est_engg`","`id` = '".$_SESSION['quickEstLoginSess']['id']."' AND `status` = '1'","id DESC","1");
		...
		?>
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="../controller/updateQuickEstEngg.php" method="post" enctype="multipart/form-data">
          <input type="hidden" name="flag" value="updateQuickEstEngg">
          <input type="hidden" name="id" value="<?php echo $_SESSION['quickEstLoginSess']['id']; ?>">
          <input type="hidden" name="redirect" value="quick">
                    <div class="row">
                      <div class="col-md-4">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="work_experience" class="form-control" value="<?php echo $row['work_experience']; ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Working Since</label>
                          <input type="text" name="working_since" class="form-control" value="<?php echo $row['working_since']; ?>">
                        </div>
                      </div>
            <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Speciality In</label>
                          <input type="text" name="speciality_in" class="form-control" value="<?php echo $row['speciality_in']; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="queries_completed" class="form-control" value="<?php echo $row['queries_completed']; ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
          ...
          <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group" style="text-align: center;">
                          <img src="../uploads/estimate-engg/<?php echo $row['profile_picture']; ?>" onerror=this.src="../assets/img/renovation-file.jpg" style="width: 100px;height: 100px;border-radius: 20px;">
                        </div>
                      </div>
                      <div class="col-md-3">
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="javascript:;">
                    <img class="img" src="../uploads/estimate-engg/<?php echo $row['profile_picture']; ?>" onerror=this.src="../assets/img/renovation-file.jpg" />
                  </a>
                </div>
                <div class="card-body">
                  <h6 class="card-category text-gray">Quick Estimate Engineer</h6>
                  <h4 class="card-title"><?php echo $row['name'];?></h4>
                  <a href="javascript:;" class="btn btn-warning btn-round">Follow</a>
                </div>
              </div>
            </div>
			<?php  }    ?>
  ...
  <?php if(isset($_SESSION) && $_SESSION['message'] == "Success"){ ?>
	  <script>md.showNotification('top','center','Profile updated successfully','warning')</script>
