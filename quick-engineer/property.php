                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
					<?php  
						$record = $ob->commonSelectJoin("property.*,client.name as client_name","property","client","property.customer_id = client.id where property.engineer_id = '".$_SESSION['quickEstLoginSess']['id']."'");
