    ...
    <div class="main-panel">
      ...
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Add Heads Sub Category</h4>
                </div>
                <div class="card-body">
                  <form action="controller/addHeadsSubCategory.php" method="post" enctype="multipart/form-data">
				            <input type="hidden" name="flag" value="addHeadsSubCategory">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <select name="head_id" class="form-control" onchange="getCategory(this.value)">
                            ...
                            <?php  
                              $record = $ob->commonSelect("heads","name ASC","15");
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <select name="measur_unit" class="form-control">
                            <option value="Sqft & Rtf">Sqft & Rtf</option>
                            <option value="Sqft">Sqft</option>
                            <option value="Rtf">Rtf</option>
                            <option value="In No">In No</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-md-8">
        ...
        <?php  
          ...
          foreach($record as $row){
        ?>
                          <label><input type="checkbox" name="admin_ids[]" value="<?php echo $row['id']; ?>" checked >&nbsp;&nbsp;<?php echo $row['name']; ?></label>&nbsp;&nbsp;&nbsp;
        <?php  }  ?>
                        </div>
                      </div>
                    </div>
