            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Add Heads Category</h4>
                </div>
                <div class="card-body">
                  <form action="controller/addHeadsCategory.php" method="post" enctype="multipart/form-data">
				            <input type="hidden" name="flag" value="addHeadsCategory">
                    <div class="row">
                      <div class="col-md-4">
